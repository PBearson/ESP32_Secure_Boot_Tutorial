...
Secure boot is a security mechanism supported by the ESP32 that verifies the integrity of the application (and the bootloader) at boot-time. First, it is important to understand how the secure boot procedure works, which is explained below:
